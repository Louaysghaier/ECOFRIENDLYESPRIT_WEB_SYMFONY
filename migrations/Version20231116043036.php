 ...
 */
final class Version20231116043036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, id_transport_id INT DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, lieu_depart VARCHAR(255) NOT NULL, lieu_arrive VARCHAR(255) NOT NULL, date_ticket DATETIME NOT NULL, statut_ticket VARCHAR(255) NOT NULL, INDEX IDX_97A0ADA3BAC8B44D (id_transport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
